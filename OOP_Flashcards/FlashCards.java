...
public class FlashCards 
{
    ...
    public static void main(String[] args) 
    {
        ...
        while (true) 
        {
            int cardIndex = random.nextInt(numCards);
            ...
            if (selectedCard.attempt(userInput)) 
            {
                System.out.println("\u001B[32mCorrect!\u001B[0m");//added color
            } 
            
            else 
            {
                System.out.println("\u001B[31mNo, the term is " + selectedCard.getTerm()+ "\u001B[0m"); //added color
            }
            System.out.println();
        }
